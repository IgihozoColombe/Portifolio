  ...
  useEffect(() => {
    request.get().then((res) => {
      if (typeof res === "string") {
        // setError(res); // todo restore when there is real API
        setIsLoaded(true); // todo remove when there is real API
        setData(VendorData); // todo remove when there is real API
      } else {
        setIsLoaded(true);
        setData(VendorData);
      }
