...
class DeliveryOrderCreate extends React.Component {
    ...
    return (
      ...
      <>
        ...
        <div className="form-row">
          ...
          <div className="col">
            <input type="text" className="form-control" name="total" value={this.props.details.total} onChange={(e) => this.props.onChange(e)} placeholder="total amount" />
          </div>
        </div>
