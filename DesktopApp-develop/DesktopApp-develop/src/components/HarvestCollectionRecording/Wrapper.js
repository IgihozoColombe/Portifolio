    ...
    request.get().then(res => {
      if (typeof res === 'string') {
        ...
        switch (props.heading) {
          case "Harvest Collection Recording":
            setData(harvestData.recording);
            break;
          case "Harvest Collection Issues":
            setData(harvestData.issues);
            break;
          case "Harvest Collection Remarks":
            setData(harvestData.remark);
            break;
          case "Harvest Collection Assigns":
            setData(harvestData.assign);
            break;
